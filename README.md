...
│   ├── evaluation/             # Evaluator, ablation studies
│   └── utils/                  # Logging, helpers
├── dashboard/                  # Flask teacher dashboard
├── scripts/                    # CLI scripts for preprocessing, training, evaluation, inference
├── research/                   # Architecture docs, math formulations, methodology, ethics
├── checkpoints/                # Saved model weights
├── data/                       # Dataset storage
...
The system includes a high-performance Flask-based web dashboard that provides real-time monitoring and analytics for teachers. Open `http://127.0.0.1:5000` in your browser after running the command above to view the dashboard.
